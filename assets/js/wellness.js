document.addEventListener('DOMContentLoaded', () => {
    ...
    moods.forEach((mood) => mood.addEventListener('click', () => { moods.forEach((item) => { item.classList.remove('selected'); item.setAttribute('aria-pressed', 'false'); }); mood.classList.add('selected'); mood.setAttribute('aria-pressed', 'true'); if (selectedMood) selectedMood.value = mood.dataset.mood; }));
